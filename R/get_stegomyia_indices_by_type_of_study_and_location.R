...
#' "clean_raw_data".
#' @param st The type of study selected, "Encuesta" or "Verificacion". By
#'  default, it is set to "Verificacion".
#' @param var The geographic variable "Sector" used to calculate the Stegomyia
#'  indices.
...
#' study and geographic variable of sector.
#'
#'
#' @examples
#'
...
get_stegomyia_indices_by_type_of_study_and_loc <- function(
    ...
    st = "Verificacion",
    var,
    path_out="data-raw/statusindicesloc.csv"
) {
  filtered_df <- df %>%
